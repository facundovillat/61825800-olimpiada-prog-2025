...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        <title>Perfil de usuario - TurisApp</title>
        ...
        <div class="relative min-h-screen flex flex-col">
            ...
            <main class="flex-grow py-12 px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto">
                    ...
                    <div class="bg-white dark:bg-dark-bg-secondary shadow overflow-hidden sm:rounded-lg mb-8">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700">
                            <dl>
                                ...
                                <div class="bg-white dark:bg-dark-bg-secondary px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                                        {{ is_array($user->profile->skills ?? null) ? implode(', ', $user->profile->skills) : ($user->profile->skills ?? 'N/A') }}
                                    </dd>
                                </div>
                                <div class="bg-gray-50 dark:bg-dark-bg-primary px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                ...
                                <div class="bg-white dark:bg-dark-bg-secondary px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                                        {{ number_format($user->profile->rating ?? 0, 2) }}
                                    </dd>
                                </div>
                            </dl>
                        </div>
                    ...
                    {{-- Sección de paquetes publicados o reservados --}}
                    
                    <div class="mt-8 bg-white dark:bg-dark-bg-secondary shadow overflow-hidden sm:rounded-lg">
                            ...
                            <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <li class="px-4 py-4 sm:px-6">
                                    <div class="flex items-center justify-between">
                                        <p class="text-sm font-medium text-indigo-600 dark:text-indigo-400 truncate">{{ $booking->package->destination }}</p>
                                        <div class="ml-2 flex-shrink-0 flex">
                                            <p class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800 dark:bg-opacity-20">
                                    ...
                                    <div class="mt-2 sm:flex sm:justify-between">
                                        <div class="sm:flex">
                                            <p class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                                                 <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400 dark:text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd" />
                                                </svg>
                                               Fecha de Reserva: {{ $booking->created_at->format('d/m/Y') }}
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                @empty
                                 <li class="px-4 py-4 sm:px-6 text-sm text-gray-500 dark:text-gray-400">No has realizado ninguna reserva todavía.</li>
                                @endforelse
                            </ul>
                        </div>
                    </div>
