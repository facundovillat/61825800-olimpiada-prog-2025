...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        <title>TurisApp - Tu próxima aventura te espera</title>
                ...
                <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            <h1 class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">TurisApp</h1>
                        </div>
            ...
            <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div class="max-w-3xl mx-auto mb-12">
                    <div class="flex shadow-lg rounded-lg overflow-hidden">
                        <input type="text" placeholder="Buscar paquetes por destino, hotel o palabra clave" class="flex-1 px-6 py-4 text-gray-700 dark:text-gray-300 dark:bg-dark-bg-secondary focus:outline-none">
                        <button class="px-8 bg-indigo-600 text-white hover:bg-indigo-700 transition-colors duration-200">
                            Buscar
                        </button>
                    </div>
                </div>
                ...
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-extrabold text-gray-900 dark:text-white sm:text-5xl sm:tracking-tight lg:text-6xl mb-4">
                        Encuentra el viaje de tus sueños
                    </h2>
                    <p class="text-xl text-gray-600 dark:text-gray-400 mb-8">
                        Conectamos viajeros con las mejores ofertas en vuelos y estadías.
                    </p>
                    <div class="flex justify-center space-x-4">
                        <a href="/paquetes" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                            Buscar Paquetes
                        </a>
                        <a href="/registro" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 dark:text-indigo-400 bg-white dark:bg-dark-bg-secondary hover:bg-gray-50 dark:hover:bg-dark-bg-primary">
                            Registrarme
                        </a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div class="bg-white dark:bg-dark-bg-secondary p-6 rounded-lg shadow-md">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Destinos Increíbles</h3>
                        <p class="text-gray-600 dark:text-gray-400">Explora una amplia variedad de destinos en todo el mundo.</p>
                            </div>
                    <div class="bg-white dark:bg-dark-bg-secondary p-6 rounded-lg shadow-md">
                        <div class="text-indigo-600 dark:text-indigo-400 mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Reservas Seguras</h3>
                        <p class="text-gray-600 dark:text-gray-400">Nuestro sistema de reservas es rápido, fácil y completamente seguro.</p>
                            </div>
                    <div class="bg-white dark:bg-dark-bg-secondary p-6 rounded-lg shadow-md">
                        <div class="text-indigo-600 dark:text-indigo-400 mb-4">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">Nuestro equipo de soporte está disponible para ayudarte en cualquier momento.</p>
                    </div>
                </div>

                <!-- Categorías populares -->
                <div class="mb-16">
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-8">Destinos Populares</h3>
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="/paquetes?categoria=playa" class="bg-white dark:bg-dark-bg-secondary p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                            <h4 class="font-medium text-gray-900 dark:text-white">Playa</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Relax, sol y mar</p>
                        </a>
                        <a href="/paquetes?categoria=montana" class="bg-white dark:bg-dark-bg-secondary p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                            <h4 class="font-medium text-gray-900 dark:text-white">Montaña</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Aire puro y aventura</p>
                        </a>
                        <a href="/paquetes?categoria=ciudad" class="bg-white dark:bg-dark-bg-secondary p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                            <h4 class="font-medium text-gray-900 dark:text-white">Ciudad</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Cultura y vida urbana</p>
                        </a>
                        <a href="/paquetes?categoria=aventura" class="bg-white dark:bg-dark-bg-secondary p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                            <h4 class="font-medium text-gray-900 dark:text-white">Aventura</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Adrenalina y naturaleza</p>
                        </a>
                    </div>
                </div>
            </main>
                ...
                <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                        <p class="text-center text-gray-500 dark:text-gray-400">
                            &copy; 2025A TurisApp. Todos los derechos reservados.
                        </p>
                    </div>
                </div>
            </footer>
